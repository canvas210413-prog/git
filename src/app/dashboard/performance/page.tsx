...
export default function PerformancePage() {
  const menuItems = [
    {
      title: "통합 대시보드",
      description: "협력사별 매출, 공급가, 배송비, 마진을 통합 분석합니다",
      icon: <BarChart2 className="h-8 w-8" />,
      href: "/dashboard/performance/integrated",
    ...
    {
      title: "상품별 성과",
      description: "등록 상품의 주문 현황을 분석하여 옵션 구성에 활용합니다",
      icon: <Package className="h-8 w-8" />,
      href: "/dashboard/performance/products",
    ...
    {
      title: "협력사 통계",
      description: "협력사별 주문 및 A/S 통계를 분석합니다",
      icon: <BarChart2 className="h-8 w-8" />,
      href: "/dashboard/performance/statistics",
