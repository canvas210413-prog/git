...
const CATEGORY_INFO: Record<string, { displayName: string; description: string }> = {
  ...
  '고객 관리': { displayName: '고객 관리', description: '고객 상담, 리뷰, AS 관리' },
  '운영 관리': { displayName: '운영 관리', description: '주문, 재고, 파트너, 쇼핑몰' },
  '분석': { displayName: '분석', description: '성과 분석 및 리포트' },
